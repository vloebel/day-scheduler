...
$(document).ready( function () {
  ...
  let currentHour = moment().format("HH:mm");
  let temp=moment(testHour).set("hour", )
  ...
  if (moment(testHour,"hour").isBefore(cHour ,"hour")) {console.log("before!");}
  else { console.log("after!"); }

  console.log('comparing cHour.isBefore testHour')
  if (moment(cHour, "hour").isBefore(testHour , "hour")) {console.log("before!");}
  else { console.log("after!"); }
});
